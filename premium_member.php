...
$premium_members = $result->fetch_all(MYSQLI_ASSOC);
          ...
          <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
              ...
              <ul class="breadcrumb">
                ...
                <li><a class="active">สมาชิกพรีเมียม</a>
                </li>
              </ul>
              <!-- END BREADCRUMB -->
            </div>
        ...
        <div class="container-fluid container-fixed-lg">
          ...
          <div class="panel panel-transparent">
              ...
              <div class="pull-right">
                <div class="col-xs-12">
                  <input type="text" id="search-table" class="form-control pull-right"
                    placeholder="ค้นหาข้อมูลสมาชิกพรีเมียม" style="font-family: 'K2D', sans-serif;">
                </div>
            ...
            <div class="panel-body">
              <table class="table table-hover demo-table-search table-responsive-block" id="pre_memberTable">
                <thead>
                  <tr>
                    <th style="width: 80px; font-family: 'K2D', sans-serif;">รหัสสมาชิกพรีเมียม</th>
                    <th style="width: 80px; font-family: 'K2D', sans-serif;">รหัสสมาชิก</th>
                    <th style="font-family: 'K2D', sans-serif;">วันเริ่มต้น</th>
                    <th style="font-family: 'K2D', sans-serif;">วันหมดอายุ</th>
                    <th style="font-family: 'K2D', sans-serif;">สถานะ</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                  foreach ($premium_members as $index => $premium_member) {
                    ?>
                    <tr>
                      <td class="v-align-middle semi-bold">
                        <?php echo $premium_member['premiumID'] ?>
                      </td>
                      <td class="v-align-middle">
                        <?php echo $premium_member['memberID'] ?>
                      </td>
                      <td class="v-align-middle">
                        <?php echo $premium_member['start_date'] ?>
                      </td>
                      <td class="v-align-middle">
                        <?php echo $premium_member['end_date'] ?>
                      </td>
                      <td class="v-align-middle">
                        <?php echo $premium_member['status'] ?>
                      </td>
