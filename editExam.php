                    ...
                    <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                        <div class="inner">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#" class="active">แก้ไขข้อมูลบทเรียน</a>
                                </li>
                            </ul>
                            <!-- END BREADCRUMB -->
                        </div>
                                        ...
                                        <form role="form" method="post" id="editCourse" enctype="multipart/form-data">
                                            <input type="hidden" name="id" id="id"
                                                ...
                                                <!-- <span class="help">e.g. "Mona Lisa Portrait"</span> -->
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $course['courseID'] ?>" <?php echo $isSelect ?>>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="question" name="question"
                                                    class="form-control" value="<?php echo $exam['question'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>รูป</label>
                                                <!-- <span class="help">e.g. "some@example.com"</span> -->
                                                <input type="file" id="picture" name="picture" class="form-control" value="<?php echo $exam['qPicUrl'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>ตัวเลือกที่ 1</label>
                                                <!-- <span class="help">e.g. "some@example.com"</span> -->
                                                <input id="choice_1" name="choice_1" class="form-control" value="<?php echo $exam['choice_1'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>ตัวเลือกที่ 2</label>
                                                <!-- <span class="help">e.g. "some@example.com"</span> -->
                                                <input id="choice_2" name="choice_2" class="form-control" value="<?php echo $exam['choice_2'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>ตัวเลือกที่ 3</label>
                                                <!-- <span class="help">e.g. "some@example.com"</span> -->
                                                <input id="choice_3" name="choice_3" class="form-control" value="<?php echo $exam['choice_3'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>คำตอบ</label>
                                                <!-- <span class="help">e.g. "some@example.com"</span> -->
                                                <input id="answer_correct" name="answer_correct" class="form-control" value="<?php echo $exam['answer_correct'] ?>">
                                            </div>
