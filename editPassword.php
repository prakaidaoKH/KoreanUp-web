...
if (isset($_POST['saveButton'])) {
    ...
    if ($_POST['confirmPass'] != $admin['password']) {
        ...
        document.location.href = 'editPassword.php';
        </script>
        ";
        exit;
        //         echo "
                                    ...
                                    <div class="panel-body">
                                        <form role="form" method="post" id="editCourse" enctype="multipart/form-data">
                                            ...
                                            <button style="background-color: #FFB09F; text-align: center;"
                                                class="btn btn-primary btn-cons m-t-10 pull-right save-pass"
                                                type="submit" name="saveButton">บันทึก</button>
