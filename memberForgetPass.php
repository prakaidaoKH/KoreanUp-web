...
$memberForgetPass = $result->fetch_all(MYSQLI_ASSOC);
        ...
        <div class="page-content-wrapper ">
            ...
            <div class="content ">
                    ...
                    <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                        <div class="inner">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a class="active">สมาชิกลืมรหัสผ่าน</a>
                                </li>
                            </ul>
                            <!-- END BREADCRUMB -->
                        </div>
                ...
                <div class="container-fluid container-fixed-lg">
                  ...
                  font-size: 24px;
                  font-family: 'K2D', sans-serif;">สมาชิกลืมรหัสผ่าน
                                </div>
                            </div>
                            <div class="pull-right">
                                <div class="col-xs-10">
                                    <input type="text" id="search-table" class="form-control pull-right"
                                        placeholder="ค้นหาข้อมูลสมาชิก" style="font-family: 'K2D', sans-serif;">
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            <table class="table table-hover demo-table-search table-responsive-block"
                                id="memberForgetPassTable">
                                <thead>
                                    <tr>
                                        <th style="width: 120px; font-family: 'K2D', sans-serif;">รหัสสมาชิกลืมรหัสผ่าน
                                        </th>
                                        <th style="font-family: 'K2D', sans-serif;">รหัสสมาชิก</th>
                                        <th style="font-family: 'K2D', sans-serif;">ชื่อผู้ใช้งาน</th>
                                        <th style="font-family: 'K2D', sans-serif;">อีเมล</th>
                                        <th style="width: 200px; font-family: 'K2D', sans-serif;">
                                            รหัสยืนยัน</th>
                                        <th style="width: 500px; font-family: 'K2D', sans-serif;">ตัวดำเนินการ</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    foreach ($memberForgetPass as $index => $member) {
                                        ?>
                                        <tr>
                                            <td class="v-align-middle semi-bold">
                                                <?php echo $member['forgetPassID'] ?>
                                            </td>
                                            ...
                                            <td class="v-align-middle">
                                                <?php echo $member['confirmPass'] ?>
                                            </td>
                                            <td class="v-align-middle">
                                                <a href="sendConfirmPass.php?action=addPass&id=<?php echo $member['forgetPassID'] ?> "
                                                    class="edit-button">สร้างรหัส</a>
                                                <a href="sendPass.php?action=sendPass&id=<?php echo $member['forgetPassID'] ?> "
                                                    class="update-button">ส่งรหัส</a>
     ...
     * ============================================================ */
        (function ($) {
            ...
            var initMemberTable = function () {
                var table = $('#memberForgetPassTable');
